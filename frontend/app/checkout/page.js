...
import { cartAPI, orderAPI, couponAPI } from '@/lib/api'
...
export default function CheckoutPage() {
  ...
  const applyCoupon = async () => {
    ...
    try {
      ...
      alert(`Coupon applied! You saved ${formatPrice(response.data.discount)}`)
    } catch (error) {
            ...
            <div className="lg:col-span-2 space-y-6">
              ...
              <div className="bg-white rounded-lg p-6">
                ...
                <div className="space-y-3">
                  ...
                  <label className="flex items-center gap-3 p-4 border-2 rounded-lg cursor-pointer hover:border-primary opacity-50">
                    <input
                      type="radio"
                      name="paymentMethod"
                      value="card"
